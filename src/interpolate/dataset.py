...
from interpolate.dataarray import interpolate_track_data_arrray
from interpolate.geometry import Geometry, convert_to_track_set
...
def tracks_as_dataset(time, drifter_tracks: Mapping[str, pd.DataFrame]) -> xarray.DataArray:
    tracks = {}
