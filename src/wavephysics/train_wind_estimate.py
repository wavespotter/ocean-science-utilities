...
from wavephysics.balance.wind_inversion import windspeed_and_direction_from_spectra
from wavespectra.spectrum import FrequencySpectrum, FrequencyDirectionSpectrum, WaveSpectrum
from wavephysics.windestimate import estimate_u10_from_spectrum
...
def prep_data(
    ...
    return spectrum.np.where(mask), target_u10[mask.values]
