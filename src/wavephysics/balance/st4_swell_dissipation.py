...
from wavephysics.fluidproperties import AIR, WATER, FluidProperties, GRAVITATIONAL_ACCELERATION
from wavephysics.generation import WindGeneration, TWindInputType
from wavespectra.operations import integrate_spectral_data
from wavespectra.spectrum import FrequencyDirectionSpectrum, SPECTRAL_DIMS
...
class SwellDissipation(WindGeneration):
    ...
    def rate_U10(
        ...
        friction_velocity = air.vonkarman_constant * speed / np.log(10 / roughness_length)
        return self.rate_friction_velocity(
            friction_velocity,
            direction,
            spectrum,
