...
from wavephysics.fluidproperties import GRAVITATIONAL_ACCELERATION, AIR, WATER
from wavephysics.balance.jb23_tail_stress import tail_stress_parametrization_jb23
...
def _jb23_wind_generation_point(
    ...
    mutual_angle = (radian_direction - wind_direction_radian + np.pi) % (2 * np.pi) - np.pi
