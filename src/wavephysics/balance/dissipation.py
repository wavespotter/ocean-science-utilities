...
from wavephysics.balance._numba_settings import numba_nocache_parallel, numba_default
...
def _dissipation(
    ...
    dissipation = np.empty((number_of_points, number_of_frequencies, number_of_directions))
