...
from filecache.cache_object import TEMPORARY_DIRECTORY, CACHE_SIZE_GB, FileCache
from filecache.remote_resources import RemoteResource
...
# =============================================================================
def set(name, value, cache_name: str = None) -> None:
    """
    Set cache value.
