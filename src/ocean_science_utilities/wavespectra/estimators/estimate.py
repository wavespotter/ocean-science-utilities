...
from ocean_science_utilities.wavespectra.estimators.mem2 import mem2
from ocean_science_utilities.wavespectra.estimators.mem import mem
...
def estimate_directional_distribution(
    ...
    **kwargs,
    ...
    if a1.ndim == 1:
        ...
        input_shape = [int(np.prod(a1.shape[0:-1])), a1.shape[-1]]
    ...
    if method != "mem2":
        ...
        msg = (
            f"Reconstructing 2d spectrum with {method}"
            f" using solution_method {solution_method}"
        )
