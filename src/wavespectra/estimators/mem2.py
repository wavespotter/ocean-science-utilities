...
from wavespectra.estimators.mem import numba_mem
from wavespectra.estimators.utils import get_direction_increment
...
def mem2_scipy_root_finder(
    directions_radians: np.ndarray,
    a1: Union[np.ndarray, float],
    b1: Union[np.ndarray, float],
    a2: Union[np.ndarray, float],
    b2: Union[np.ndarray, float],
    progress,
    **kwargs
) -> np.ndarray:
    """
